...
class Runtime {
  constructor(config, environment, resolver, transformer, cacheFS, coverageOptions, testPath) {
    ...
    this._fakeTimersImplementation =
      config.timers === "legacy" ? this._environment.fakeTimers : this._environment.fakeTimersModern;
    ...
    const envExportConditions =
      (_this$_environment$ex =
        (_this$_environment$ex2 = (_this$_environment = this._environment).exportConditions) === null ||
        _this$_environment$ex2 === void 0
          ? void 0
          : _this$_environment$ex2.call(_this$_environment)) !== null && _this$_environment$ex !== void 0
        ? _this$_environment$ex
        : [];
  ...
  static createHasteMap(config, options) {
    const ignorePatternParts = [
      ...
      config.cacheDirectory.startsWith(config.rootDir + path().sep) && config.cacheDirectory,
    ].filter(Boolean);
  ...
  resolveModule(specifier, referencingIdentifier, context) {
    ...
    if (
      this._shouldMock(referencingIdentifier, path, this._explicitShouldMockModule, {
    ...
    if (module.status === "unlinked") {
      ...
      this._esmModuleLinkingMap.set(
        ...
        module.link((specifier, referencingModule) =>
          this.resolveModule(specifier, referencingModule.identifier, referencingModule.context)
        )
      );
    }
  ...
  getExportsOfCjs(modulePath) {
    ...
    const transformedCode =
      (_this$_fileTransforms =
        (_this$_fileTransforms2 = this._fileTransforms.get(modulePath)) === null || _this$_fileTransforms2 === void 0
          ? void 0
          : _this$_fileTransforms2.code) !== null && _this$_fileTransforms !== void 0
        ? _this$_fileTransforms
  ...
  requireModule(from, moduleName, options, isRequireActual = false) {
    ...
    const isInternal =
      (_options$isInternalMo = options === null || options === void 0 ? void 0 : options.isInternalModule) !== null &&
  ...
  requireInternalModule(from, to) {
    if (to) {
      ...
      const require = (
        (_nativeModule$createR = nativeModule().createRequire) !== null && _nativeModule$createR !== void 0
  ...
  isolateModules(fn) {
    ...
    try {
      ...
      (_this$_isolatedModule = this._isolatedModuleRegistry) === null || _this$_isolatedModule === void 0
        ? void 0
        : _this$_isolatedModule.clear();
      (_this$_isolatedMockRe2 = this._isolatedMockRegistry) === null || _this$_isolatedMockRe2 === void 0
        ? void 0
  ...
  resetModules() {
    ...
    (_this$_isolatedModule2 = this._isolatedModuleRegistry) === null || _this$_isolatedModule2 === void 0
      ? void 0
      : _this$_isolatedModule2.clear();
    (_this$_isolatedMockRe3 = this._isolatedMockRegistry) === null || _this$_isolatedMockRe3 === void 0
      ? void 0
    ...
    if (this._environment) {
      if (this._environment.global) {
        ...
        Object.keys(envGlobal).forEach((key) => {
          ...
          if (
            ((typeof globalMock === "object" && globalMock !== null) || typeof globalMock === "function") &&
    ...
    return this._v8CoverageResult
      ...
      .filter(
        (
          ...
          (0, _transform().shouldInstrument)(res.url, this._coverageOptions, this._config)
      )
      .map((result) => {
    ...
    try {
      ...
      return new (_vm().Script)(this.wrapCodeInModuleWrapper(scriptSource), {
        ...
        importModuleDynamically: async (specifier) => {
          ...
          const context =
            (_this$_environment$ge = (_this$_environment2 = this._environment).getVmContext) === null ||
            _this$_environment$ge === void 0
              ? void 0
  ...
  _requireCoreModule(moduleName, supportPrefix) {
    const moduleWithoutNodePrefix =
      supportPrefix && moduleName.startsWith("node:") ? moduleName.slice("node:".length) : moduleName;
        ...
        if (typeof filename !== "string") {
          const error = new TypeError(
            `The argument 'filename' must be string. Received '${filename}'.${
              filename instanceof _url().URL ? " Use createRequire for URL filename." : ""
            }`
          ); // @ts-expect-error
  ...
  _shouldMock(from, moduleName, explicitShouldMock, options) {
    ...
    if (
      ...
      (from.includes(NODE_MODULES) &&
        ...
        ((this._unmockList && this._unmockList.test(from)) || explicitShouldMock.get(currentModuleID) === false))
    ) {
      this._transitiveShouldMock.set(moduleID, false);
  ...
  _createJestObjectFor(from) {
    ...
    const mocked =
      (_this$_moduleMocker$m =
        (_this$_moduleMocker$m2 = this._moduleMocker.mocked) === null || _this$_moduleMocker$m2 === void 0
          ? void 0
          : _this$_moduleMocker$m2.bind(this._moduleMocker)) !== null && _this$_moduleMocker$m !== void 0
        ? _this$_moduleMocker$m
        : () => {
  ...
  _logFormattedReferenceError(errorMessage) {
    const testPath = this._testPath
      ? ` From ${(0, _slash().default)(path().relative(this._config.rootDir, this._testPath))}.`
      : "";
    const originalStack = new ReferenceError(`${errorMessage}${testPath}`).stack
      .split("\n") // Remove this file from the stack (jest-message-utils will keep one line)
      .filter((line) => line.indexOf(__filename) === -1)
      .join("\n");
    const { message, stack } = (0, _jestMessageUtil().separateMessageFromStack)(originalStack);
    console.error(
      `\n${message}\n` +
