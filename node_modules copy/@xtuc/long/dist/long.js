!(function (t, i) {
  ...
  return (function (t) {
    ...
    return (
      ...
      (i.c = n),
      (i.d = function (t, n, h) {
        i.o(t, n) || Object.defineProperty(t, n, { configurable: !1, enumerable: !0, get: h });
      }),
      (i.n = function (t) {
        var n =
          t && t.__esModule
    ...
    function (t, i) {
      ...
      function e(t, i) {
        ...
        return i
          ? ((t >>>= 0),
            (e = 0 <= t && t < 256) && (h = l[t]) ? h : ((n = r(t, (0 | t) < 0 ? -1 : 0, !0)), e && (l[t] = n), n))
          : ((t |= 0),
            (e = -128 <= t && t < 128) && (h = f[t]) ? h : ((n = r(t, t < 0 ? -1 : 0, !1)), e && (f[t] = n), n));
      }
      function s(t, i) {
      ...
      n.prototype.__isLong__, Object.defineProperty(n.prototype, "__isLong__", { value: !0 }), (n.isLong = h);
      var f = {},
        l = {};
      ...
      (B.toInt = function () {
        ...
        (B.divide = function (t) {
          ...
          if (this.unsigned) {
            ...
            if (this.eq(_)) {
              ...
              return (
                ...
                i.eq(m) ? (t.isNegative() ? y : N) : ((n = this.sub(t.mul(i))), (e = i.add(n.div(t))))
              );
            }
          ...
          for (n = this; n.gte(t); ) {
            ...
            for (
              var o = Math.ceil(Math.log(i) / Math.LN2), f = o <= 48 ? 1 : a(2, o - 48), l = s(i), d = l.mul(t);
              d.isNegative() || d.gt(n);
        ...
        (B.shiftLeft = function (t) {
          return (
            ...
            0 == (t &= 63)
              ? this
              : t < 32
              ? r(this.low << t, (this.high << t) | (this.low >>> (32 - t)), this.unsigned)
        ...
        (B.shiftRight = function (t) {
          return (
            ...
            0 == (t &= 63)
              ? this
              : t < 32
              ? r((this.low >>> t) | (this.high << (32 - t)), this.high >> t, this.unsigned)
        ...
        (B.rotateLeft = function (t) {
          ...
          return (
            ...
            0 == (t &= 63)
              ...
              : t < 32
              ? ((i = 32 - t),
                r((this.low << t) | (this.high >>> i), (this.high << t) | (this.low >>> i), this.unsigned))
              : ((t -= 32),
                (i = 32 - t),
                r((this.high << t) | (this.low >>> i), (this.low << t) | (this.high >>> i), this.unsigned))
          );
        }),
        (B.rotl = B.rotateLeft),
        (B.rotateRight = function (t) {
          ...
          return (
            ...
            0 == (t &= 63)
              ...
              : t < 32
              ? ((i = 32 - t),
                r((this.high << i) | (this.low >>> t), (this.low << i) | (this.high >>> t), this.unsigned))
              : ((t -= 32),
                (i = 32 - t),
                r((this.low << i) | (this.high >>> t), (this.high << i) | (this.low >>> t), this.unsigned))
          );
        }),
