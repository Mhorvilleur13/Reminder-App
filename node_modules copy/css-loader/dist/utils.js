...
function escapeLocalIdent(localident) {
  ...
  return escape(
    localident // For `[hash]` placeholder
      .replace(/^((-?[0-9])|--)/, "_$1")
  ...
  for (let tier = 0; localIdentHash.length < hashDigestLength; tier++) {
    ...
    const hash =
      loaderContext.utils && typeof loaderContext.utils.createHash === "function"
        ? loaderContext.utils.createHash(hashFunction) // eslint-disable-next-line no-underscore-dangle
...
function getModulesOptions(rawOptions, exportType, loaderContext) {
  ...
  const resourcePath = (loaderContext._module && loaderContext._module.matchResource) || loaderContext.resourcePath; // eslint-disable-next-line no-underscore-dangle
  let auto;
...
function normalizeOptions(rawOptions, loaderContext) {
  ...
  return {
    ...
    importLoaders:
      typeof rawOptions.importLoaders === "string" ? parseInt(rawOptions.importLoaders, 10) : rawOptions.importLoaders,
