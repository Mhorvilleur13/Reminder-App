var idb = (function (e) {
  ...
  function u(e) {
    return e !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype
      ? (
          n || (n = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])
        ).includes(e)
        ? function (...t) {
  ...
  function d(e) {
    return "function" == typeof e
      ...
      : (e instanceof IDBTransaction &&
        ...
        (n = e),
        (t || (t = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some((e) => n instanceof e)
          ? new Proxy(e, c)
          : e);
    var n;
  }
  ...
  return (
    (c = ((e) => ({ ...e, get: (t, n, r) => b(t, n) || e.get(t, n, r), has: (t, n) => !!b(t, n) || e.has(t, n) }))(c)),
