...
declare type IDBPIndexExtends = Omit<
  IDBIndex,
  "objectStore" | "count" | "get" | "getAll" | "getAllKeys" | "getKey" | "openCursor" | "openKeyCursor"
>;
...
declare type IDBPCursorExtends = Omit<
  IDBCursor,
  "key" | "primaryKey" | "source" | "advance" | "continue" | "continuePrimaryKey" | "delete" | "update"
>;
...
> extends IDBPCursorExtends {
  ...
  update: Mode extends "readonly"
    ? undefined
    : (value: StoreValue<DBTypes, StoreName>) => Promise<StoreKey<DBTypes, StoreName>>;
  /**
...
declare type IDBPCursorIteratorValueExtends<
  ...
  IndexName extends IndexNames<DBTypes, StoreName> | unknown = unknown,
  Mode extends IDBTransactionMode = "readonly"
> = Omit<IDBPCursor<DBTypes, TxStores, StoreName, IndexName, Mode>, "advance" | "continue" | "continuePrimaryKey">;
