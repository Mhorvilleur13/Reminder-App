  ...
  (this.workbox.strategies = (function (t, e, s, r, n, i, a, o, c) {
    ...
    class l {
      ...
      async fetch(t) {
        ...
        try {
          for (const t of this.iterateCallbacks("requestWillFetch")) r = await t({ request: r.clone(), event: s });
        } catch (t) {
          if (t instanceof Error)
            throw new e.WorkboxError("plugin-error-request-will-fetch", { thrownErrorMessage: t.message });
        }
        const i = r.clone();
        try {
          let t;
          t = await fetch(r, "navigate" === r.mode ? void 0 : this.ot.fetchOptions);
          for (const e of this.iterateCallbacks("fetchDidSucceed")) t = await e({ event: s, request: i, response: t });
          return t;
        } catch (t) {
          throw (
            (n &&
      ...
      async cacheMatch(t) {
        ...
        for (const t of this.iterateCallbacks("cachedResponseWillBeUsed"))
          s = (await t({ cacheName: r, matchOptions: n, cachedResponse: s, request: i, event: this.event })) || void 0;
        return s;
      }
      async cachePut(t, s) {
        const n = h(t);
        ...
        if (!s) throw new e.WorkboxError("cache-put-with-no-response", { url: a.getFriendlyURL(o.url) });
        ...
        for (const t of this.iterateCallbacks("cacheDidUpdate"))
          await t({ cacheName: w, oldResponse: p, newResponse: l.clone(), request: o, event: this.event });
        return !0;
      }
    ...
    class w {
      ...
      async kt(t, s, r) {
        ...
        for (const e of t.iterateCallbacks("handlerWillRespond")) n = await e({ event: r, request: s, response: n });
        return n;
      }
      async xt(t, e, s, r) {
        let n, i;
        ...
        try {
          await e.runCallbacks("handlerDidRespond", { event: r, request: s, response: n }), await e.doneWaiting();
        } catch (t) {
          t instanceof Error && (i = t);
        }
        if (
          (await e.runCallbacks("handlerDidComplete", { event: r, request: s, response: n, error: i }), e.destroy(), i)
        )
          throw i;
      }
    }
    ...
    return (
      (t.CacheFirst = class extends w {
        async _handle(t, s) {
          ...
          if (!r) throw new e.WorkboxError("no-response", { url: t.url, error: n });
          return r;
        }
      }),
      ...
      (t.NetworkFirst = class extends w {
        ...
        async _handle(t, s) {
          ...
          let i;
          if (this.Rt) {
            const { id: e, promise: a } = this.Wt({ request: t, logs: r, handler: s });
            (i = e), n.push(a);
          }
        ...
        async _handle(t, s) {
          ...
          try {
            ...
            if (((r = await Promise.race(e)), !r))
              throw new Error("Timed out the network response after " + this.Rt + " seconds.");
          } catch (t) {
            t instanceof Error && (n = t);
          }
          if (!r) throw new e.WorkboxError("no-response", { url: t.url, error: n });
      ...
      (t.StaleWhileRevalidate = class extends w {
        ...
        async _handle(t, s) {
          ...
          if (!i) throw new e.WorkboxError("no-response", { url: t.url, error: n });
          return i;
        }
      }),
      (t.Strategy = w),
