...
Ep.getTryLocsList = function () {
  ...
  return t.arrayExpression(
    this.tryEntries.map(function (tryEntry) {
      ...
      var locs = [
        tryEntry.firstLoc, // The null here makes a hole in the array.
        ce ? ce.firstLoc : null,
      ];
...
Ep.explodeStatement = function (path, labelId) {
  ...
  switch (stmt.type) {
    ...
    case "ForInStatement":
      ...
      self.emitAssign(
        keyIterNextFn,
        t.callExpression(util.runtimeProperty("keys"), [self.explodeExpression(path.get("right"))])
      );
      self.mark(head);
  ...
  switch (expr.type) {
    ...
    case "YieldExpression":
      ...
      if (arg && expr.delegate) {
        ...
        var _ret = t.returnStatement(
          t.callExpression(self.contextProperty("delegateYield"), [arg, t.stringLiteral(_result.property.name), after])
        );
